...
class BeerSongTest {
    ...
    fun firstGenericVerse() {
        ...
        assertEquals(expected, BeerSong.verses(99))
    }
    ...
    fun lastGenericVerse() {
        ...
        assertEquals(expected, BeerSong.verses(3))
    }
    ...
    fun verse2() {
        ...
        assertEquals(expected, BeerSong.verses(2))
    }
    ...
    fun verse1() {
        ...
        assertEquals(expected, BeerSong.verses(1))
    }
    ...
    fun verse0() {
        ...
        assertEquals(expected, BeerSong.verses(0))
    }
